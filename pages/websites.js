    ...
    <Grid container direction="column">
      <Head>
        ...
        <meta
          name="description"
          key="description"
          content="Completely custom design and built from scratch to be blazing fast. Optimized code, server-side rendering, and perfect responsive design | 99% PageSpeed Score."
        />
        <meta
          property="og:title"
          content="Bringing West Coast Technology to the Midwestg | Websites"
          key="og:title"
        />
